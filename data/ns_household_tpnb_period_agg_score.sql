-- ============================================================
-- 05_new_basket_source.sql
--
-- Feeds  : score_new_baskets.py's --new-transactions input
-- Grain  : identical to 04_household_tpnb_period_agg.sql — same real,
...
DROP TABLE IF EXISTS lab_customer_value_analytics.ns_household_tpnb_period_agg_score;

CREATE TABLE lab_customer_value_analytics.ns_household_tpnb_period_agg_score
USING PARQUET
AS
SELECT
    year_number,
...
FROM lab_customer_value_analytics.ns_household_tpnb_period_agg_score
;